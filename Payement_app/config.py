...
class Config:
    ...
    GOOGLE_API_KEY_7 = os.environ.get("GOOGLE_API_KEY_7")   
    GOOGLE_API_KEY_8 = os.environ.get("GOOGLE_API_KEY_8")
    GOOGLE_API_KEY_9 = os.environ.get("GOOGLE_API_KEY_9")    
    GOOGLE_API_KEY_10 = os.environ.get("GOOGLE_API_KEY_10")
